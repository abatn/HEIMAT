...
-- KEINE SEED-DATEN
-- ============================================
-- Alle Ärzte kommen live von OpenStreetMap Overpass — weltweit,
-- standortunabhängig, keine Hardcodierung auf eine Stadt.
-- Wenn ein User einen Overpass-Arzt bucht, wird er dynamisch in
-- die doctors-Tabelle überführt (healthService.ensureDoctorInDb()).
