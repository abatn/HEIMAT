# HEIMAT 2.0 – Endbenutzer-Testing
...
#### Mobilität
1. Klicke auf "Mobilität" unten
2. Gib Start und Ziel ein
3. Klicke auf Suchen
4. Prüfe die Verbindungen

#### Finanzen
1. Klicke auf "Finanzen" unten
2. Prüfe das Guthaben
3. Klicke auf "Geld senden"
4. Gib Empfänger und Betrag ein

#### Gesundheit
1. Klicke auf "Gesundheit" unten
2. Suche nach einem Arzt
3. Klicke auf "Termin buchen"
4. Fülle das Formular aus

### Schritt 3: Feedback geben
- Erstelle ein GitHub Issue: https://github.com/abatn/HEIMAT/issues
- Oder schreibe im Matrix-Room: https://matrix.to/#/heimat:matrix.org

---

## Für Mobile App (Android)

### Schritt 1: APK herunterladen
1. Gehe zu: https://github.com/abatn/HEIMAT/releases
2. Lade die neueste APK herunter
3. Installiere die APK (Einstellungen → Apps → Unbekannte Quellen)

### Schritt 2: App öffnen
- Tippe auf das HEIMAT-Icon
...
1. Gehe zu: https://github.com/abatn/HEIMAT/releases
2. Lade die neueste IPA herunter
3. Installiere über AltStore oder TestFlight
...
1. Gehe zu: https://github.com/abatn/HEIMAT/issues/new
2. Wähle "Bug Report" oder "Feature Request"
3. Beschreibe das Problem oder die Idee
4. Klicke "Submit new issue"

### Option 2: Matrix-Room
1. Öffne: https://matrix.to/#/heimat:matrix.org
2. Beschreibe das Problem oder die Idee
3. Warte auf Antwort

### Option 3: E-Mail
- Sende ein E-Mail an: feedback@heimat-app.de
...
Jede Rückmeldung hilft uns, HEIMAT 2.0 zu verbessern.
